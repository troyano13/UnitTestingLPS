...
public class ManageUsersTest {
    ...
    private ManageUsers manageUsersController;
    ...
    @Before
    public void setUp() {
        manageUsersController = new ManageUsers();
    ...
    public void testDoGet() throws ServletException, IOException {
        ...
        manageUsersController.doGet(request, response);
    ...
    public void testDoPost() throws ServletException, IOException {
        ...
        manageUsersController.doPost(request, response);
